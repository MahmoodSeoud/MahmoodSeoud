...
## Recent Work
I recently completed my bachelor's thesis on creating a Bluetooth mesh grid network with an adaptive protocol. It's set to be published at the COPA conference soon (details [here](https://ieee-copa.org/)). 
